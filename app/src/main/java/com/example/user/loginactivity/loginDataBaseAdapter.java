...
import static com.example.user.loginactivity.DataBaseHelper.TABLE_NAME;
...
public class loginDataBaseAdapter {
    ...
    {
        Cursor cursor=db.query(TABLE_NAME, null," c_name_th=?", new String[]{userName},null,null,null);
